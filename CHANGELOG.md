...
### Added
 ...
 - Miscellaneouse: gate all the bookkeeping optimizations under the following options:
...
### Fixed
 ...
 - Statistics & Graphviz: treat barrier instantiation as a standalone interaction.
...
### Fixed
 ...
 - Garbage collection: free the eraser that faces an auxiliary port of a zero-duplicator.

## 2.0.0 - 2026-02-25

### Removed

 - Reduction semantics: side-effectfull semantics through the `perform` & `bind` operators.
