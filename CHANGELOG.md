...
### Removed
 ...
 - Miscellaneouse: the built-in fixed-point combinator.
   - (1) it is uselesse with references; (2) it creates vicious circles that act badly with garbage collection.
